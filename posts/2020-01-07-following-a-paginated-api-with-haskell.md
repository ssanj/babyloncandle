...
a little command line application that limits my interaction with Twitter to a select few accounts and searches. 
...
and here's an example of a non-empty result:
...
I have omitted the bindings for clarity_.
